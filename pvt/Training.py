...
def Val_test(test_loader, model, epoch, save_path, best_mae, best_epoch, args):
    ...
    with torch.no_grad():
        ...
        for i, data_batch in enumerate(test_loader):
            ...
            _, _, GW, GH = gt.shape
            res = F.interpolate(mask_1_1, size=(GW, GH), mode='bilinear', align_corners=False)
...
def main(local_rank, num_gpus, args):
    ...
    for epoch in range(args.epochs):
        ...
        for i, data_batch in enumerate(train_loader):
            ...
            images, depths, label_224, label_7, label_14, label_28, label_56, label_112 = data_batch
            ...
            label_7, label_14, label_28, label_56, label_112  = (Variable(label_7.cuda()), Variable(label_14.cuda()),
                                                                 Variable(label_28.cuda()), Variable(label_56.cuda()), Variable(label_112.cuda()))
            ...
            # loss
            loss9 = criterion(mask_1_32, label_7)
            loss8 = criterion(toprgbd, label_7)
            loss7 = criterion(topdepth, label_7)
            loss6 = criterion(toprgb, label_7)
            ...
            img_total_loss = loss_weights[0] * loss1 + loss_weights[1] * loss2+ loss_weights[3] * loss4 + loss_weights[4] * loss5\
                             + loss_weights[4] * loss6+ loss_weights[4] * loss7+ loss_weights[4] * loss8+ loss_weights[4] * loss9
