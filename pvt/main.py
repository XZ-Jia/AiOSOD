...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode', default='pvt_v2_b0', type=str, help='select pretrained model')
    ...
    parser.add_argument('--pretrained_model', default='pvt_v2_b0.pth', type=str, help='load pretrained model')
    ...
    parser.add_argument('--checkpoint', default='pvt_v2_b0_best.pth', type=str, help='save saliency maps path')
