...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode', default='T2T_ViT_10', type=str, help='select pretrained model')
    ...
    parser.add_argument('--pretrained_model', default='75.2_T2T_ViT_10.pth.tar', type=str, help='load pretrained model')
    ...
    parser.add_argument('--checkpoint', default='T2T_ViT_10_best.pth', type=str, help='save saliency maps path')
